  ...
  return (
    <div className="cla-text">
        ...
        <ol className="c3 lst-kix_xdh80phlgwv-2 start" start="1">
          ...
          <li className="c2 li-bullet-0"><span className="c7">Grant of Patent License</span><span
            className="c1">. &nbsp;Subject to the terms and conditions of this Agreement, You hereby grant to Arrow, its affiliates, and to recipients of software distributed by Arrow or its affiliates, a perpetual, worldwide, non-exclusive, no-charge, royalty-free, sublicensable, irrevocable (except as stated in this section) patent license to make, have made, use, offer to sell, sell, import, and otherwise transfer the Work, where such license applies only to those patent claims licensable by You that are necessarily infringed by Your Contribution(s) alone or by combination of Your Contribution(s) with the Work to which such Contribution(s) was submitted. &nbsp;</span>
          </li>
          <li className="c2 li-bullet-0"><span className="c7">Revocation of Patent License</span><span
        ...
        <ol className="c3 lst-kix_xdh80phlgwv-0" start="4">
          ...
          <li className="c0 li-bullet-0"><span className="c4">Disclaimers</span><span
            className="c1">. &nbsp;EXCEPT FOR AND WITHOUT LIMITING YOUR REPRESENTATIONS UNDER THIS AGREEMENT, (I) YOUR CONTRIBUTION IS PROVIDED &ldquo;AS IS&rdquo;, AND (II) ALL EXPRESS OR IMPLIED WARRANTIES INCLUDING, WITHOUT LIMITATION, ANY IMPLIED WARRANTY OF SATISFACTORY QUALITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT ARE EXPRESSLY DISCLAIMED BY YOU TO US AND BY US TO YOU. &nbsp;TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN DURATION AND EXTENT TO THE MINIMUM PERIOD AND EXTENT PERMITTED BY LAW. </span>
          </li>
          <li className="c0 li-bullet-0"><span className="c4">Miscellaneous</span><span
            className="c1">. </span>
          </li>
        </ol>
        <ol className="c3 lst-kix_xdh80phlgwv-2 start" start="1">
          ...
          <li className="c2 li-bullet-0"><span>This Agreement will be governed and construed under the laws of the State of </span><span>New York</span><span>&nbsp;without regard to conflicts of law provisions. &nbsp;Any suit or proceeding arising out of or relating to this Agreement will be brought in the federal or state courts, as applicable, in </span><span>New York County (Manhattan), New York</span><span
            className="c1">, and each party irrevocably submits to the jurisdiction and venue of such courts.</span>
          </li>
          <li className="c2 li-bullet-0"><span className="c1">This Agreement sets out the entire agreement between You and Us for Your Contributions to Us and overrides all other agreements or understandings.</span>
          </li>
          <li className="c2 li-bullet-0"><span className="c1">Arrow may assign this Agreement to: (i) any of its affiliates; or (ii) any entity in connection with a reorganization, merger, consolidation, acquisition, or other transaction involving all or substantially all of the voting securities or assets of Arrow. &nbsp;The Agreement will be binding upon, enforceable by and inure to the benefit of the parties and each of their successors and permitted assigns.</span>
          </li>
          <li className="c2 li-bullet-0"><span className="c1">In case of Your death, this agreement shall continue with Your heirs. &nbsp;In case of more than one heir, all heirs must exercise their rights through a commonly authorized person.</span>
          </li>
