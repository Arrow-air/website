...
Arrow pays for real work, and it does it in the open. There are two funding shapes, and knowing which one fits is most of the battle: a **bounty** funds a defined task, a **grant** funds ongoing time.
