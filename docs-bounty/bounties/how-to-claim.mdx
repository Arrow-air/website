...
<Steps>
  <Step title="Find a bounty">
    Browse the [Active Bounties](/bounty) board and find an OPEN bounty that matches your skills. Click the **GitHub** link to read the full requirements in the issue.
  </Step>
