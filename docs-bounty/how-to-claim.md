...
Browse the [Active Bounties](/bounty) board and find an OPEN bounty that matches your skills. Click the **Outline** link to read the full requirements on GitHub.
